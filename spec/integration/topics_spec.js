...
describe("routes : topics", () => {
  ...
  describe("admin user performing CRUD actions for Topic", () => {
    ...
    describe("GET /topics/new", () => {
      ...
      it("should render a new topic from", (done) => {
      ...
      it("should NOT create a new topic", (done) => {
        ...
        request.post(options,
          ...
          (err, res, body) => {
            Topic.findOne({where: {title: "blink-182 songs"}})
            .then((topic) => {
              expect(topic).toBeNull(); //no topic should be there
              done();
            })
            .catch((err) => {
              console.log(err);
      ...
      it("should NOT update the topic with the given values", (done) => {
        const options = {
          ...
          request.post(options,
            ...
            .then((topic) => {
              expect(topic.title).toBe("JS Frameworks"); //title should be unchanged
              done();
            });
          });
      });
